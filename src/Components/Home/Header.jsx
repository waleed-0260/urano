...
const Header = () => {
  ...
  return (
    <>
      <div data-aos="fade-down" className='fixed top-0 left-0 w-full flex items-center justify-between flex-row bg-black px-3 border-b-[1px] border-b-[#27292b] z-50'>
        ...
        <Link to={"/dapp"} className='rounded-md lg:flex hidden px-2 py-2 bg-white text-black font-semibold text-[14px] w-[120px] flex items-center justify-center'>Launch DApp</Link>
