...
const Hero = ({heading, text}) => {
  ...
  return (
    <div className='flex flex-col items-center justify-center mt-[200px] gap-4 mb-[100px] max-w-[1200px]' data-aos="fade-up">
        ...
        Coming Soon</p>
            <h1 className='heading md:w-[90%] text-center font-conthrax text-white'>{heading}</h1>
            <p className='textColor md:w-[60%] text-center p-4'>{text}</p>
    </div>
  )
}
